...
import { WiredActionLogMessageView } from './WiredActionLogMessageView';
import { WiredActionMoveAndRotateFurniView } from './WiredActionMoveAndRotateFurniView';
import { WiredActionMoveFurniGroupView } from './WiredActionMoveFurniGroupView';
...
export const WiredActionLayoutView = (code: number) =>
{
    switch(code)
    {
        ...
        case WiredActionLayoutCode.TELEPORT:
            ...
            case WiredActionLayoutCode.ACTION_LOG_MESSAGE:
    return <WiredActionLogMessageView />;
        case WiredActionLayoutCode.ACTION_MOVE_FURNI_GROUP:
            return <WiredActionMoveFurniGroupView />;
        case WiredActionLayoutCode.TOGGLE_FURNI_STATE:
            return <WiredActionToggleFurniStateView />;
            case WiredActionLayoutCode.SET_USER_VARIABLE:
